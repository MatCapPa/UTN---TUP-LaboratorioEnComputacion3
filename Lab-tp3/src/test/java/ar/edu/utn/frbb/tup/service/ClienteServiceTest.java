...
public class ClienteServiceTest {
    ...
    @Test
    public void testAgregarCuentaACajas() throws TipoCuentaAlreadyExistsException {
        Cliente pepeRino = new Cliente();
        pepeRino.setDni(26456439);
        pepeRino.setNombre("Pepe");
        pepeRino.setApellido("Rino");
    ...
    @Test
    public void testAgregarCuentasACajasYMonedas() throws TipoCuentaAlreadyExistsException {
        Cliente pepeRino = new Cliente();
        pepeRino.setDni(26456439);
        pepeRino.setNombre("Pepe");
        pepeRino.setApellido("Rino");
        ...
        Cuenta cuenta2 = new Cuenta()
                ...
                .setBalance(553)  //500000 pesos = 553 dollars
                .setTipoCuenta(TipoCuenta.CAJA_AHORRO);
    ...
    @Test
    public void testClienteServicePorDNISuccess() throws ClienteAlreadyExistsException ,IllegalArgumentException{
        Cliente cliente = new Cliente();
        cliente.setFechaNacimiento(LocalDate.of(1978, 3, 25));
        cliente.setTipoPersona(TipoPersona.PERSONA_FISICA);
        cliente.setNombre("pepeRino");
        cliente.setDni(29857643);
        when(clienteDao.find(29857643,true)).thenReturn(cliente);

        Cliente verificar = clienteService.buscarClientePorDni(29857643);
        assertNotNull(verificar);
        assertEquals(cliente,verificar);
    ...
    @Test
    public void testClienteServiceBuscarPorDNIFailed() throws  ClienteAlreadyExistsException,IllegalArgumentException{
        long dni = 12345678L;
